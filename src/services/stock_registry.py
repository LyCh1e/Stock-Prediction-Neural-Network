...
from src.core.interfaces import IHistoryRepository, IModelRepository, ISymbolRepository
from src.core.models import ScoreResult
from src.ml.network import NeuralNetwork
from src.scoring.scorer import score_symbol, score_all
...
class StockRegistry:
    ...
    def _no_score(reason: str) -> ScoreResult:
        from src.scoring.scorer import _insufficient_data_result
